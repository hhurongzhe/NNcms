...
namespace basic_math
{
    ...
    std::vector<double> gauss_legendre_nodes(int degree)
    {
    ...
    std::vector<double> gauss_legendre_weights(int degree)
    {
    ...
    std::vector<double> gauss_legendre_nodes_interval(double a, double b, int degree)
    {
    ...
    std::vector<double> gauss_legendre_weights_interval(double a, double b, int degree)
    {
